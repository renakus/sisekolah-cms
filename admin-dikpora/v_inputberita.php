  ...
  if(isset($_POST['submit'])) {
    ...
    $e_boleh = array('png','jpg','jpeg');
    $a = explode('.',$gambar);
    $ekstensi = strtolower(end($a));
    $size = $_FILES['gambar']['size'];
    $f_tmp = $_FILES ['gambar']['tmp_name'];

    if(in_array($ekstensi,$e_boleh)===true) {
      if($size < 1044070) {
        move_uploaded_file($f_tmp,'file/'.$gambar);
        $query = "INSERT INTO berita (judul,headline,isi,tanggal,waktu,penulis,gambar) VALUES ('$judul', '$headline','$isi', '$tanggal', '$waktu', '$penulis','$gambar')";
  ...
  <div class="wrapper">
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group  col-sm-11">
        ...
        <input type="file" class="form-control" name="gambar" value="input">
      </div>
      <div class="form-group  col-sm-11">
