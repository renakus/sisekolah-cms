        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img src="admin-dikpora/file/<?php echo $row['gambar']; ?>" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <h3 class="sidebar-title">Recent Posts</h3>
                 <?php
             $data = $conn->query("select * from berita order by tanggal desc limit 5");
              if ($data->num_rows > 0) {
              while ($row = $data->fetch_array()) {
           ?>
              <div class="sidebar-item recent-posts">
                <div class="post-item clearfix">
                  <img src="admin-dikpora/file/<?php echo $row['gambar']; ?>" alt="">
                  <h4>
                    <a href="berita_detail.php?id=<?php echo $row['id'];?>">
                      <?php echo $row['judul']; ?>
                    </a>
                  </h4>
                  <time><?php echo $row['tanggal']; ?></time>
