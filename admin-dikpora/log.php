...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="v_pesan.php">
            <i class="fa fa-dashboard"></i> <span>Pesan</span>
          </a>
        </li>
        <li class="active">
          <a href="log.php">
  ...
  <div class="content-wrapper">
    ...
    <tr>
      ...
      <?php
        $no=1;
        $data = $conn->query("select * from log where akses='http://localhost/sekolah/admin-dikpora/cek_login.p'");
