...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box-body">
        <a style="cursor: pointer;" href="v_input_datasekolah.php" class="btn btn-primary btn-sm">
    ...
    <tr>
      ...
      <?php
        $no=1;
        $data = $conn->query("select * from data_sekolah");
      ...
      <tr>
        ...
        <td><?php echo $row['jumlah_pegawai']; ?></td>
        <td><?php echo $row['akreditasi']; ?></td>
        <td>
          <a href="edit_datasekolah.php?npsn=<?php echo $row['npsn'];?>" class="btn btn-warning btn-sm" name="update">
            <span class="glyphicon glyphicon-edit"></span>
          </a>
          <a href="delete_datasekolah.php?npsn=<?php echo $row['npsn'];?>" class="btn btn-danger btn-sm">
