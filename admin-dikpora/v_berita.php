...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box-body">
        <a style="cursor: pointer;" href="v_inputberita.php" class="btn btn-primary btn-sm">
    ...
    <tr>
      ...
      <tr>
        ...
        <td><img src="file/<?php echo $row['gambar']; ?>" style="width: 50px; height:auto;"></td>
        <td><?php echo $row['tanggal']; ?></td>
        <td><?php echo $row['waktu']; ?></td>
        <td><?php echo $row['penulis']; ?></td>
        <td>
          <a href="edit_berita.php?id=<?php echo $row['id'];?>" class="btn btn-warning btn-sm" name="update">
            <span class="glyphicon glyphicon-edit"></span>
          </a>
          <a href="delete_berita.php?id=<?php echo $row['id'];?>" class="btn btn-danger btn-sm">
